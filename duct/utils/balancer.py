"""
Taken from: https://github.com/facebookresearch/encodec/blob/main/encodec/balancer.py
"""
...
class Balancer:
    ...
    potentially rescaling the gradients, which can help stabilize the training and reason about 
    multiple losses with varying scales.
